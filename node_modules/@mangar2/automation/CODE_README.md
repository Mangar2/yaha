...
- [Class Automation](#Class-Automation)
  ...
  - [Methods](#Automation-Methods)
    - [_handleSimulation](#_handleSimulation)
...
##### _handleSimulation Parameters

| Name | Type | Description |
| ---------- | ------------ | ----------------- |
| `message` | `Message` | message received in simulation mode | |
...
##### _showVariables Parameters

| Name | Type | Description |
| ---------- | ------------ | ----------------- |
| `usedVariables` | `Object` | name : value map of varialbes | |
...
| Type | Description |
| ---- | ----------- |
| `Object` | map of variables ( variable name/variable value ) |
...
| Type | Description |
| ---- | ----------- |
| `Array.<Message>` | list of messages as result ( always empty ) |

#### processRules

`processRules (date) => {Array.<Message>}`

Loops through all rules and processes them

##### processRules Parameters

| Name | Type | Attribute | Description |
| ---------- | ------------ | ------------ | ----------------- |
| `date` | `Date` | optional | current date/time | |

##### processRules returns
