...
class Automation {
    ...
    processMessage (message) {
        ...
        if (this._simulation) {
            ...
            const topicMatch = new TopicMatch(this._motionTopics)
            const isMotion = topicMatch.getFirstMatch(message.topic) !== undefined
     ...
     * @param {Object} recentEvents.nonMotions list of non motion events
    ...
    processTasks (date = new Date(), simulation = false) {
        ...
        let result = { messages: [], usedVariables: {} }
        this._processRule.date = new Date(date.getTime())
