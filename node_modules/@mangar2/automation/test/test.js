        ...
        rules: {
            heating: {
                ...
                check: {
                    and: [{
                        operator: '<',
                        operands: ['outdoor/temperature', 18]
                    },
                    {
                        operator: '<',
                        operands: ['indoor/temperature', 23]
                    }]
                },
                topic: '$SYS/heating',
                value: 'on'
...
function printMessages (messages) {
    ...
    unitTest.log(JSON.stringify(topics) + ',')
    unitTest.log(JSON.stringify(values) + ',')
    unitTest.log(JSON.stringify(times) + ',')
    unitTest.log(JSON.stringify(reasons))
}
