...
class Mqtt {
    ...
    onConnect (payload, headers) {
        ...
        const result = mqttVersion.onConnect(headers, { present: connect.present, token: connect.token })
    ...
    onPingreq (payload) {
        ...
        this._publishLogMessage('ping', 'success', 'client request', payload.clientId)
