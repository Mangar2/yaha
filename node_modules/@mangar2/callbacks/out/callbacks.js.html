...
class Callbacks {
     ...
     * @param {string} name name of the callback to look for
     * @returns {boolean} true, if the callback is registered
     */
    hasCallback (name) {
        return this._callbacks[name.toLowerCase()] !== undefined
    }
...
<nav>
    <h2><a href="index.html">Home</a></h2><h3>Classes</h3><ul><li><a href="Callbacks.html">Callbacks</a></li></ul>
</nav>

<br class="clear">

<footer>
    Documentation generated by <a href="https://github.com/jsdoc/jsdoc">JSDoc 3.6.3</a> on Wed Mar 25 2020 21:53:59 GMT+0100 (GMT+01:00)
</footer>
