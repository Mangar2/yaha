...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: checkinput.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: checkinput.js</h1>
...
class CheckInput {
    constructor (definition, options = {}) {
        ...
        this._checkSubschema = (definition, variable) => {
            return this._checkSchema(definition, variable)
        }
    }
