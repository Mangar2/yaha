...
let unitTest = new UnitTest(true);
...
unitTest.assertTrue(result, "check1 " + JSON.stringify(check.getMessages()));

// correct
var result = check2.validate({clientId: "/a/b", subscribe: {QoS:1, topics:["topic1", "topic2", "topic32"]}});
unitTest.assertEqual(result, true, "check2: " + JSON.stringify(check2.getMessages()));

// not correct
var result = check2.validate({clientId: "/a/b", subscribe: {QoS:1, topics:[5, "topic1", "topic2", "topic32"]}});
unitTest.assertEqual(result, false, "check2: " + JSON.stringify(check2.getMessages()));
