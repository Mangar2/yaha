...
unitTest.assertEqual(result, false, 'check2: ' + JSON.stringify(check2.messages, null, 2))

result = check2.validate({ clientId: '/a/c', subsibe: { QoS: 1, topics: [5, 'topic1', 'topic2', 'topic32'] } })
unitTest.assertFalse(result, 'check2: ' + JSON.stringify(check2.messages, null, 2))

unitTest.showResult(27)
