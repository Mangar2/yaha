...
module.exports = class Connect {
    ...
    async connect(clean, version = '1.0') {
        ...
        let httpObjects = mqttVersion.connect(version, this.clientId, this.myAddress, this.listenerPort, clean);
        let result = await this.putJsonMessage("/connect", httpObjects.headers, httpObjects.payload);
    ...
    async disconnect(version = '1.0') {
        let httpObjects = mqttVersion.disconnect(version, this.clientId);
        let result = await this.putJsonMessage("/disconnect", httpObjects.headers, httpObjects.payload);
    ...
    async subscribe(topics, version = '1.0') {
        let httpObjects = mqttVersion.subscribe(version, topics, this.clientId, this.providePacketId());
        
        let result = await this.putJsonMessage("/subscribe", httpObjects.headers, httpObjects.payload);
    ...
    async unsubscribe(topics, version = '1.0') {
        ...
        let httpObjects = mqttVersion.unsubscribe(version, topics, this.clientId, this.providePacketId());
        let result = await this.putJsonMessage("/unsubscribe", httpObjects.headers, httpObjects.payload);
    ...
    async connectAndSubscribe(clean, topics, version = '1.0') {
        ...
        if (this.isConnected) {
            let subscribeResult = await this.subscribe(topics, version);
