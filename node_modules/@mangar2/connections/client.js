...
module.exports = class Client {
     ...
     * @returns {Object} map topic/topic queue
     */
    get orderedTopicsQueue () { return this._orderedTopicsQueue }

    /**
     * Sets the ordered topics queues
     * @param {Object} queues {topic: queue, topic: queue, ...} one queue per topic
     */
    set orderedTopicsQueue (queues) {
        this._orderedTopicsQueue = queues
    }

    /**
     * Gets the queue for qos=0 messages
     * @returns { MessageQueueEntry[] } queue for qos0 messages
     */
    get qos0Queue () { return this._qos0Queue }

    /**
     * Sets the queue for qos=0 messages
     * @param { MessageQueueEntry[] } queue for qos0 messages
     */
    set qos0Queue (queue) {
        this._qos0Queue = queue
    }

    /**
     * Sets the will message
     * @returns {Object} will message configuration
     */
