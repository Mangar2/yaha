...
module.exports = class Connections {
     ...
     * @param {nubmber} configuration.timeoutInMilliseconds timeout to wait for an answer
    ...
    autoDisconect () {
        for (const clientId in this.clients) {
            ...
            if (!isAlive) {
                this.publishWill(clientId, client.getWill())
            }
        }
    }
    ...
    publishWill (clientId, will) {
        if (will !== undefined) {
            ...
            const message = new Message(topic, value, 'client ' + clientId + ' was auto disconnected')
            this.publishMessage(message, qos, retain)
        }
    }
