...
module.exports = class Connections {
    ...
    async restoreFromFile() {
        let data = persistConnections.readData(this.configuration.directory, this.configuration.fileName);
        if (data !== undefined) {
    ...
    async sendMessage(client, messageQueueEntry, callback) {
        ...
        let packetid = qos == 1 || qos == 2 ? messageQueueEntry.getId() : undefined;
        let data = Connections.createSendData(client, messageQueueEntry);
        try {
