...
module.exports = class MessageQueueEntry {
    ...
    /**
     * @returns {0|1} 1 signals that a message is send due to a retain subscription
     */
    get retain () { return this._retain }
    /**
     * @param {0|1} retain, 1 signals that the message is send due to a retain subscription
     */
