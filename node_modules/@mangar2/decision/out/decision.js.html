...
<head>
    <meta charset="utf-8">
    <title>JSDoc: Source: decision.js</title>
...
<div id="main">
    ...
    <h1 class="page-title">Source: decision.js</h1>
...
class Decision {
    ...
    _evalString (string) {
        ...
        if (string.includes('/')) {
            ...
            const explainVariable = (types.getType(value) === 'Date') ? value.toLocaleTimeString() : value
