...
class Devices {
     ...
     */
    topicToDevice (topic) {
        return this.attributeToDevices('topic', topic)[0]
    }
     ...
     * @returns {object[]} array of devices with the same value for attributeName
     */
    attributeToDevices (attributeName, attributeValue) {
        ...
        if (result === undefined) {
            throw Error('unknown attribute ' + attributeValue)
        }
        return result
    }
}
