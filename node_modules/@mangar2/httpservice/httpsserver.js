...
module.exports = class HTTPSServer {
    ...
    /**
     * Sets a callback
     * @param {string} event RESTful https verb (POST, GET, PUT, PATCH, DELETE)
     * @param {function} callback(payload, headers, path, res)
     * where payload is the https payload, headers the https headers, res the result structure and path is
     * is the https path as string
     */
    on (event, callback) {
    ...
    listen () {
        this.server = https.createServer(options, (req, res) => {
            try {
                ...
                const path = HTTPSServer.getPath(req)
                let payload = ''
