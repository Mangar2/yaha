...
class HTTPSServer {
     ...
     * @returns { address: string, family: string, port: number } ip address, family an port
     */
    get address() {
        return this._server.server.address()
    }

    /**
     * Sets a callback
     * @param {string} event RESTful http verb (POST, GET, PUT, PATCH, DELETE, OPTIONS) 
     * and 'listen' (called once listening) and 'closed' (called once closed)
     ...
     */
    listen (options) {
        this._server.listen(https, options)
    }
