...
/**
 * @class
 * @classdesc Matches incoming "set" messages and outgoing messages to fill up the reason info
 */
class MatchMessages {
    /**
    ...
    addReceivedMessage (message) {
        ...
        if (lastPartOfTopic === 'set' || lastPartOfTopic === 'get') {
    ...
    matchAndUpdateReplyMessage (message) {
        ...
        if (this._messageList[topic]) {
            ...
            const valueMatches = this._messageList[topic].value === message.value
