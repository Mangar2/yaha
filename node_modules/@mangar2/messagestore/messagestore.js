...
function getFromObject (theObject, propertyName, propertyValue) {
    ...
    if (theObject !== undefined && propertyName !== undefined && isString(propertyName)) {
        if (!theObject.hasOwnProperty(propertyName) && propertyValue !== undefined) {
...
module.exports = class MessageStore {
    ...
    static isValueUnchanged (series, value) {
        ...
        if (series.length > 1) {
            ...
            const secondLastValue = series[series.length - 2][1]
    ...
    static updateData (node) {
        ...
        if (typeof (value) !== 'object') {
            ...
            const series = node.series[node.series.length - 1]
    ...
    static updateContent (node, content, maxHistoryLength, historyHysterese) {
        if (node.hasOwnProperty('value')) {
            const entry = { time: node.time, value: node.value, reason: node.reason }
