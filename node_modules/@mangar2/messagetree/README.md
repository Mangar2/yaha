...
`getSection (topic, levelAmount, addHistory, addReason) => {Object.<topics:Array, payload:Object>}`
...
| Type | Description |
| ---- | ----------- |
| `Object.<topics:Array, payload:Object>` | Object with topics and payloads of all nodes in output format for these ( sub ) topics |
