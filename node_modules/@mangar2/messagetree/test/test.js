...
const MessageStore = require('@mangar2/messagetree')
...
var messageStore = new MessageStore(CONFIG)
...
// Check history
unitTest.assertEqual(node.history.length, 2, 'a/b 3')
...
const section = messageStore.getSection('/c/a/a', 1)
