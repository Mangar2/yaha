...
function testAddMessage () {
    ...
    unitTest.assertEqual(node.value, 'on', 'add message 1')
...
function testDifferentReason () {
    ...
    unitTest.assertEqual(node.value, 'on', 'different 2')
    messageTree.addData(new Message('a/different', 'off', 'reason 12'))
    unitTest.assertEqual(node.value, 'off', 'different 3')
    ...
    unitTest.assertEqual(node.history[node.history.length - 2].value, 'on', 'different 7')
    unitTest.assertEqual(node.history[0].value, 'on', 'different 8')
    unitTest.assertEqual(node.history[1].value, 'on', 'different 9')
