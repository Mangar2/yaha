...
class Motion {
    constructor (options, rulesTree) {
        ...
        this._presenceTopic = types.isString(options.presenceTopic) ? options.presenceTopic : '$SYS/presence'
        ...
        if (options.presenceVariable) {
            this._setVariable(options.presenceVariable, 'initial')
        } else {
            this._setVariable('$SYS/presenc', 'initial')
        }
    }
