...
module.exports = (unitTest) => {
    ...
    motionHistory.addMotion(motion4)
    motionHistory.addMotion(motion5)
    motionHistory.addMotion(motion6)
    motionHistory.addMotion(motion1)
    motionHistory.addMotion(motion2)
    motionHistory.addMotion(motion3)

    const result = motionHistory.getLatestMotionRoomList()
    ...
    for (let i = 0; i < 10000; i++) {
        motionHistory.addMotion(new Message('/room1/motion' + i, 1, 'motion detected', new Date()))
    }
    const longList = motionHistory.getLatestMotionRoomList()
