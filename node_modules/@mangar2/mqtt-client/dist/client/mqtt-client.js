...
const src_1 = require("@mangar2/mqtt-client/src");
const DEBUG = true;
...
class MqttClient {
    constructor(options) {
        ...
        this._recipients = {};
        this._logger = new mqtt_utils_1.Logger();
        ...
        this._server = new src_1.HttpReceiveServices(listener || 0, this._logger);
        this._client = new src_1.HttpSendServices(clientId, brokerOptions, this._logger);
