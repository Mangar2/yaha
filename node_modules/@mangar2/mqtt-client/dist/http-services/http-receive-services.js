...
const on_publish_1 = require("../service/on-publish");
const on_connect_1 = require("../service/on-connect");
/**
...
class HttpReceiveServices {
     ...
     */
    constructor(port, qos2PubrelTimeoutInSeconds = 7200) {
        this._onConnect = null;
        this._httpServer = new httpservice_1.HttpServer(port);
        this._onPublish = new on_publish_1.OnPublish(qos2PubrelTimeoutInSeconds);
        this._registerPut();
    }
    /**
