...
const publish_1 = require("@mangar2/mqtt-client/src/service/publish");
const connect_1 = require("@mangar2/mqtt-client/src/service/connect");
/**
...
class HttpSendServices {
     ...
     */
    constructor(senderName, brokerOptions, logger) {
        ...
        this._connect = new connect_1.Connect(senderName, logger);
