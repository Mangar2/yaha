 ...
 */
import { IMessage, SubscribeResult, topics_t } from '@mangar2/mqtt-utils';
...
export declare class MqttClient implements IMqttClient {
    ...
    private _recipients;
    private _keepAlive;
    constructor(options: MqttClientOptions, _mqttClientServices: IMqttClientServices);
    /**
