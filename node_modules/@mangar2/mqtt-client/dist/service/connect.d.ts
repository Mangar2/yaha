 ...
 */
import { IConnectResult, IConnectOptions, SubscribeResult, UnsubscribeResult, Logger, topics_t } from '@mangar2/mqtt-utils';
...
export declare class Connect {
     ...
     */
    constructor(_clientId: string, _logger?: Logger | null);
    /**
     * Sets a callback.
     ...
     */
    connect(options: IConnectOptions): Promise<IConnectResult>;
    /**
     ...
     */
    connectAndSubscribe(topics: topics_t, connectOptions: IConnectOptions): Promise<{
