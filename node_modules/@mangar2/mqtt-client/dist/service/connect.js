...
class Connect {
     ...
     */
    constructor(_clientId, _logger = null) {
    ...
    async connect(options) {
        ...
        try {
            ...
            (_a = this._logger) === null || _a === void 0 ? void 0 : _a.log(this._clientId, `$SYS/${this._clientId}/connect`, `connected, present:${present}, send:${token.send}, receive:${token.receive}, mqttcode:${mqttcode}`, this._clientId, 0);
            return parsedResult;
        }
        catch (err) {
    ...
    async disconnect(version = '1.0') {
        try {
            const sendData = mqtt_utils_1.Interfaces.disconnect(version, this._clientId);
    ...
    async subscribe(version = '1.0', topics) {
        try {
            const sendData = mqtt_utils_1.Interfaces.subscribe(version, topics, this._clientId, this.providePacketId());
    ...
    async unsubscribe(version = '1.0', topics) {
        try {
            const sendData = mqtt_utils_1.Interfaces.unsubscribe(version, topics, this._clientId, this.providePacketId());
