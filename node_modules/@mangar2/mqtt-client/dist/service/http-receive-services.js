...
class HttpReceiveServices {
     ...
     */
    constructor(port, logPattern = [], qos2PubrelTimeoutInSeconds = 7200) {
        this._onPublish = null;
        this._onConnect = null;
        this._httpServer = new httpservice_1.HttpServer(port);
        this._onPublish = new on_publish_1.OnPublish(logPattern, qos2PubrelTimeoutInSeconds);
        this._registerPut();
    }
    /**
     ...
     * @returns {void}
     */
    enableConnect(mqttServer) {
        this._onConnect = new on_connect_1.OnConnect(mqttServer);
    }
    /**
