 ...
 */
export declare class HttpSendServices {
    private _httpClient;
    private _publish;
    private _connect;
    /**
     ...
     */
    constructor(senderName: string, brokerOptions: BrokerOptions);
    /**
     * Publishes a message
     */
    publish(token: string, message: Message, version?: string): Promise<string[]>;
    /**
