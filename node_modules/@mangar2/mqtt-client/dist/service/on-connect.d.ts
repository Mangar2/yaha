 ...
 */
import { IResult, IConnectOptions, ISubscribeOptions, IUnsubscribeOptions, Logger } from '@mangar2/mqtt-utils';
...
export declare class OnConnect {
    private mqttServer;
    private logger;
    constructor(mqttServer: IMqttServer, logger?: Logger | null);
    /**
     ...
     */
    isConnectRequest(path: string): boolean;
    /**
