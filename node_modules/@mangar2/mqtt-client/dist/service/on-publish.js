...
class OnPublish {
     ...
     */
    constructor(qos2PubrelTimeoutInSeconds = 7200) {
        this._qos2Queue = {};
    ...
    onPublish(headers, payload) {
        ...
        mqtt_utils_1.Logger.logger.logMessage({ direction: 'in', message: messageClone, dup });
     ...
     */
    onLog(payload) {
        mqtt_utils_1.Logger.logger.changePattern(payload);
