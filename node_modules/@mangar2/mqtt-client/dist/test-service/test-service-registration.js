...
const run = async () => {
    mqtt_utils_1.Logger.logger.clientName = 'test-client';
    mqtt_utils_1.Logger.logger.changePattern([{ module: 'all', topic: '$SYS/#', level: 1 }, { module: 'all', topic: '#', level: 1 }]);
    const httpClient = new http_client_services_1.HttpClient(httpClientOptions);
    const mqttClient = new mqtt_client_1.MqttClient(mqttClientOptions, httpClient);
