...
export class MqttClient implements IMqttClient {
    ...
    constructor(options: MqttClientOptions, private _mqttClientServices: IMqttClientServices, private _logger: Logger) {
    ...
    async reconnect() {
        try {
            const result = await this._mqttClientServices.connect(this._clientId, this._clean);
            this.connected = true
