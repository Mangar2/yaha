...
import { ServiceConfiguration } from './configuration-types'
...
export type prepareFunction_t = (config: ServiceConfiguration, service?: IMqttService | null) => Promise<IMqttService>;
