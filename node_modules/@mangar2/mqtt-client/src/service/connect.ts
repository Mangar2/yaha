...
import { Interfaces, IConnectResult, IConnectOptions, SubscribeResult, UnsubscribeResult, Logger, topics_t } from '@mangar2/mqtt-utils';
...
export class Connect {
     ...
     */
    async connect(options: IConnectOptions): Promise<IConnectResult> {
        try {
     ...
     */
    async connectAndSubscribe(topics: topics_t, connectOptions: IConnectOptions): 
