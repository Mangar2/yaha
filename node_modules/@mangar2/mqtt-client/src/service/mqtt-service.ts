...
import { IResult, Logger } from '@mangar2/mqtt-utils';

export class MqttService { 
    public onConnect: OnConnect;
    public onPublish: OnPublish;

    constructor(mqttServer: IMqttServer, private _logger: Logger) {
        this.onConnect = new OnConnect(mqttServer, this._logger);
        this.onPublish = new OnPublish(this._logger);
    }
