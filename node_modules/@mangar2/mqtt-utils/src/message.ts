 ...
 * @param {string|reason_t|null} [reason=null] - Explaining why the topic will be set to value
...
export class Message implements IMessage {
    public reason: reason_t | null;

    constructor(
        public topic: string,
        public value: string | number = '',
        reason: string | reason_t | null = null,
        public qos: qos_t = 1,
     ...
     * @throws {error} - Throws an exception if the validation fails
     */
    static createMessage(message: IMessage): Message {
        Message.validate(message);
        return new Message(message.topic, message.value, message.reason, message.qos, message.retain);
    }
