...
import { subscribe, onSubscribe } from  './subscribe';
import { unsubscribe, onUnsubscribe } from './unsubscribe';
import { connect, onConnect, IConnectOptions, IOnConnectOptions, IConnectResult } from './connect';
import { disconnect, onDisconnect } from './disconnect';
export { IConnectResult }
...
export const Interfaces = {
    ...
    * @description Creates the return types for a connect request
     ...
     */
    onConnect: (headers: headers_t, payload: IOnConnectOptions) => {
