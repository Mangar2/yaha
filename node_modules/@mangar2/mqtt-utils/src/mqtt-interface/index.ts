...
import { subscribe, onSubscribe, SubscribeResult } from  './subscribe';
import { unsubscribe, onUnsubscribe, UnsubscribeResult } from './unsubscribe';

import { connect, onConnect, IConnectOptions, IConnectResult } from './connect';

import { disconnect, onDisconnect } from './disconnect';
export { IConnectResult, SubscribeResult, UnsubscribeResult, IConnectOptions }
...
export const Interfaces = {
     ...
     * @returns {Object} {headers, payload, statusCode, packetid}
     */
    onSubscribe: (headers: headers_t, qosArray: number[]) => {
     ...
     * @returns {Object} {headers, payload, statusCode, packetid}
     */
    onUnsubscribe: (headers: headers_t) => {
