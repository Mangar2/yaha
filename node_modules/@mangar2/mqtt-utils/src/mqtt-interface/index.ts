...
import { subscribe, onSubscribe, ISubscribeOptions, SubscribeResult } from  './subscribe';
import { unsubscribe, onUnsubscribe, IUnsubscribeOptions, UnsubscribeResult } from './unsubscribe';

import { connect, onConnect, IConnectOptions, IConnectResult } from './connect';

import { disconnect, onDisconnect } from './disconnect';
export { IConnectResult, SubscribeResult, UnsubscribeResult, IConnectOptions, ISubscribeOptions, IUnsubscribeOptions }
...
export const Interfaces = {
     ...
     * @returns {Object} {headers, payload, resultCheck(result)}
     */
    connect: (version: string, options: IConnectOptions) => {
    ...
    * @description Creates the return types for a connect request
     ...
     */
    onConnect: (headers: headers_t, payload: IConnectResult) => {
