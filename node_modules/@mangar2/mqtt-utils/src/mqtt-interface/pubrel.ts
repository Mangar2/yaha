...
export const pubrel: Record<string, PubrelFunction> = {
    ...
    '1.0': ({ token, packetid }): RequestData => {
        /**
...
export const onPubrel: Record<string, PurelResponseFunction> = {
    ...
    '1.0': (headers: headers_t): IResultWithPacketid => {
        /**
