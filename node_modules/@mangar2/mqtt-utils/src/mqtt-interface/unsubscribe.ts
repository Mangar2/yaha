...
import { IResult, RequestData, standardHeaderJSON, standardHeaderText, topics_t, headers_t } from "./interfaces"
 ...
 */
const onUnsubscribe: Record<string, (headers: headers_t) => IResult> = {
    '0.0': headers => ({
