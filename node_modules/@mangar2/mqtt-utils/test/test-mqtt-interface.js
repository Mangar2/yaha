...
module.exports = () => {
    ...
    let publish = Interfaces.publish('0.0', TOKEN, message, 1, true, true, 1)
    let onPublish = Interfaces.receive(publish.headers)
    unitTest.assertTrue(publish.resultCheck(onPublish), 'publish ver. 0.0')

    publish = Interfaces.publish('1.0', TOKEN, message, 1, true, true, 1)
    onPublish = Interfaces.receive(publish.headers)
    ...
    onSubscribe = Interfaces.onSubscribe(subscribe.headers)
    ...
    onUnsubscribe = Interfaces.onUnsubscribe(unsubscribe.headers)
    ...
    onConnect = Interfaces.onConnect(connect.headers)
