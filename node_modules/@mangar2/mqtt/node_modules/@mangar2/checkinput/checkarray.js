...
/**
 * @private
 * @description Checks if an array does not contain any element twice.
...
/**
 * @private
 * @description Checks array data to the constrains of an array defintion
...
/**
  * @private
  * @description Checks if an array contains elements
...
/**
  * @private
  * @description Checks the items of an array having an items property of type Array
...
function checkArrayItems (definition, array, checkSubschema) {
    ...
    for (const index in array) {
        ...
        if (defItem !== undefined) {
            ...
            result.invalidate('array has more than ' + index + ' items')
            break
...
/**
  * @private
  * @description Checks an array against a definition
  * @param {Object} definition array definition
  * @param {Array} array input data
  * @param {function} checkSubschema (definition, data)
