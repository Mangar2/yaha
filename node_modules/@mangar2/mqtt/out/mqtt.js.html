...
/**
 * @callback {Mqtt~sendCallback} 'send'
...
/**
 * @callback {Mqtt~publishCallback} 'publish'
...
class Mqtt {
    ...
    onUnsubscribe (payload, headers) {
        checkUnsubscribePayload.throwOnValidationError(payload, 'Unsubscribe wrong parameters: ')
...
<nav>
    <h2><a href="index.html">Home</a></h2><h3>Classes</h3><ul><li><a href="Mqtt.html">Mqtt</a></li></ul><h3><a href="global.html">Global</a></h3>
</nav>

<br class="clear">

<footer>
    Documentation generated by <a href="https://github.com/jsdoc/jsdoc">JSDoc 3.6.3</a> on Sun Mar 15 2020 15:06:39 GMT+0100 (GMT+01:00)
</footer>
