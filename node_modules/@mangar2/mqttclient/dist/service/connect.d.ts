 ...
 */
import { IConnectResult, topics_t } from '@mangar2/mqtt-utils';
...
export declare class Connect {
     ...
     */
    constructor(clientId: string, myAddress: string, myPort: number);
    /**
     ...
     */
    connect(clean: boolean, version?: string, keepAlive?: number): Promise<IConnectResult>;
    /**
     ...
     */
    subscribe(topics: topics_t, version?: string): Promise<any>;
    /**
     ...
     * @returns {Object} empty object
     */
    unsubscribe(topics: topics_t, version?: string): Promise<any>;
    /**
     ...
     */
    connectAndSubscribe(clean: boolean, topics: topics_t, version?: string, keepAlive?: number): Promise<any>;
}
export {};
