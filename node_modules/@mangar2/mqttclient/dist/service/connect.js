...
class Connect {
     ...
     */
    async connect(version = '1.0', options) {
        try {
            options.clientId = this.clientId;
            const sendData = mqtt_utils_1.Interfaces.connect(version, options);
     ...
     */
    async connectAndSubscribe(version = '1.0', topics, connectOptions) {
