 ...
 */
import { IResult, IMessage, qos_t, topics_t, LogPattern } from '@mangar2/mqtt-utils';
export type headers_t = Record<string, string>;
type port_t = number | string;
/**
...
export interface IMqttServer {
     ...
     * @param {string} host - Host address of the server.
     * @param {port_t} port - Port number for the connection.
     * @param {boolean} clean - Flag to determine if the session should be clean.
     * @param {string} version - Protocol version.
     * @param {IMessage} will - Message to be send as last will.
     * @param {boolean} keepAlive - Flag to keep the connection alive.
     * @returns {IResult} - Result of the connection attempt.
     */
    connect(clientid: string, host: string, port: port_t, clean: boolean, version: string, will: IMessage, keepAlive: boolean): IResult;
    /**
     ...
     */
    subscribe(clientid: string, subscription: any): qos_t[];
    /**
     ...
     */
    unsubscribe(clientid: string, topics: topics_t): void;
    /**
