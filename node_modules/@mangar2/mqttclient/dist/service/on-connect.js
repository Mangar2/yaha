...
class OnConnect {
     ...
     */
    headersToMqttHeaders(headers) {
        return {
            qos: headers.qos === '1' ? 1 : (headers.qos === '2' ? 2 : 0),
            dup: headers.dup === '1' || headers.dup === 'true',
            packetid: !utils_1.Types.isString(headers.packetid) ? 0 : parseInt(headers.packetid),
            retain: headers.retain === '1' || headers.retain === 'true',
            version: utils_1.Types.isString(headers.version) ? headers.version : '0.0'
        };
    }
    /**
    * @private
    ...
    */
    ...
    onConnect(payload, headers) {
        ...
        if (utils_1.Types.isString(payload.port)) {
            payload.port = parseInt(payload.port);
        }
        checkdefinitions_1.checkConnectPayload.throwOnValidationError(payload, 'Connect wrong parameters (' + payload.clientId + '): ');
        ...
        const result = mqtt_utils_1.Interfaces.onConnect(headers, { present: (_a = connect.present) !== null && _a !== void 0 ? _a : 0, token: (_b = connect.token) !== null && _b !== void 0 ? _b : "" });
