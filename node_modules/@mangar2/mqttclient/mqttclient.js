...
class MqttClient {
            ...
            for (const recipient of this._recipients) {
                ...
                if (topicMatch.getFirstMatch(message.topic) !== undefined) {
                    ...
                    if (Array.isArray(returnMessage)) {
                        ...
                        this.publish(returnMessage, returnMessage.qos, returnMessage.retain)
                    }
                }
            }
        })
    ...
    /**
     * Gets a token
     * @returns {Object} object with send and receive tokens
     */
     ...
     * Sets a token
     * @param token
     * @param {string} token.send send token
     * @param {string} token.receive receive token
     */
     ...
     * @type {boolean} true, iff shutdown
     */
    get shutdown () { return this._shutdown }
    set shutdown (shutdown) { this._shutdown = shutdown }
     ...
     * @param {function()} callback function to call, must return an array of messages
     */
