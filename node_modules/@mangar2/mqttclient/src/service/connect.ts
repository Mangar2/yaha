...
import { Interfaces, IConnectResult, topics_t } from '@mangar2/mqtt-utils';
...
export class Connect {
     ...
     */
    async connect(clean: boolean, version: string = '1.0', keepAlive: number = 600 * 1000): Promise<IConnectResult> {
        try {
