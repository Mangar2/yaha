    ...
    },
    {
        ...
        tests: [
            ...
            },
            {
                ...
                expected: {
                    'result': 'Error sending message: acknowledge \'puback\' expected, got ',
                    'history': [
                        {
                            'path': '/publish',
                            'headers': {
            ...
            },
            {
                ...
                expected: {
                    result: 'Error sending message: packet id 3 expected, got 4',
                    history: [
                        {
                            path: '/publish',
                            method: 'put',
    ...
    },
    {
        ...
        tests: [
            ...
            },
            {
                ...
                expected: {
                    result: 'Error in pubrel, message: acknowledge \'pubcomp\' expected, got pubrec',
                    'history': [
                        {
                            path: '/publish',
                            headers: {
