...
module.exports = class Receive {
    ...
    constructor(listenerPort, qos2PubrelTimeoutInSeconds = 7200) {
        ...
        this.server.on("PUT", (payload, headers, path, res) => {
            if (path === "/publish") {
                ...
                result = this.onPubrel(headers, res);            
            } else if (path === "/log") {
    ...
    deleteOldQos2QueueEntries() {
        ...
        for (let entry in this.qos2Queue) {
            if (this.qos2Queue[entry].time + qos2PubrelTimeoutInMilliseconds < now) {
    ...
    onPublish(message, headers, res) {
        ...
        let qos2PacketPublishedBefore = dup && this.qos2Queue[packetid] !== undefined;
