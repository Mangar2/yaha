...
const ArduinoOptionsJSONSchema = {
    ...
    additionalProperties: false,
    required: ['serialPortName', 'baudrate', 'myAddress', 'maxVersion', 'tickDelay', 'qos', 'trace', 'interfaces', 'settings', 'status', 'addresses']
}
...
const defaultConfiguration = {
    ...
    status: {
        ...
        s: 'arduino tatus information/internal temperature in celsius',
