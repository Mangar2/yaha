...
class ProcessRule {
    ...
    check (rule, events) {
        ...
        const ruleMessages = result.messages
        result.messages = this._history.extractNewMessages(rule, this.date, ruleMessages)
        this._history.update(rule, this.date, ruleMessages)
        return result
    }
}
