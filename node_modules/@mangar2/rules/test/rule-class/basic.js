    ...
    },
    {
        ...
        tests: [
            ...
            },
            {
                ...
                set: { name: 'one/two/three', topic: 'world' },
                expected: { 
            ...
            },
            {
                ...
                set: { name: 'one/two/four', topic: 'four' },
                expected: { 
                    rules: [
        ...
        tests: [
            {
                ...
                set: { name: 'one/two1/r1', topic: 'new' },
                expected: { 
                    tree: {
                        one: { 
