...
function _registerSubscriptions (mqttClient, registeredObject, serviceName, prepare) {
    ...
    mqttClient.registerRecipient(serviceName, subscriptions, (message) => {
        if (message.topic === updateString) {
            const config = loadConfiguration()[serviceName]
            prepare(config, registeredObject)
 ...
 */
function registerService (mqttClient, config, serviceName, serviceImplementation) {
