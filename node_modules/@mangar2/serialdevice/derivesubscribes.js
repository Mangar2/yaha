 ...
 * @param {{topic:string}} topicMap object with topic properties
 * @param {0,1,2} qos quality of service for the subscription
 * @returns {{topic: qos}} object with topic: qos entries
 */
