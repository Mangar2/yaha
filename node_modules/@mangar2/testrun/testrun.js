...
class Testrun {
    constructor (verbose = false, parallel = false) {
        ...
        this._callbacks = new Callbacks(['prepare', 'run', 'validate', 'break', 'followup'])
        this._unitTest = new UnitTest(this._verbose, this._verbose)
        this._fileContent = null
        this._testNo = 0
        this._parallel = parallel
        this.on('validate', (test, result, testPath) => this.validate(test, result, testPath))
        this.on('prepare', () => {})
    }
    ...
    async _asyncRunTestcase (testcase, testcasePath, testNo) {
        ...
        await this._callbacks.invokeCallbackAsync('followup', testObject)
    }
    ...
    _runTestcase (testcase, testcasePath, testNo) {
        ...
        this._callbacks.invokeCallback('followup', testObject)
    }
    ...
    async asyncRun (files, directory, expectedAmount, extension = 'json') {
        ...
        this.unitTest.showResult(expectedAmount)
    }
