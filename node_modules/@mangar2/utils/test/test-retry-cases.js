...
module.exports = [
    ...
    /*
    {
        description: 'should stop previous retry loop and call global callback function 2 times with a delay of 500ms for topic "hello"',
        functionName: 'topicRetry',
        tests: [
            {
                description: 'should stop previous retry loop and call the global callback function the expected number of times',
                functionName: 'topicRetry',
                input: ['hello', 2, 500],
                expected: { callbackFunctionCallCount: 2 }
            }
        ]
    }
    */
