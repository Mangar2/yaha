 ...
 */
 class ZwaveService {
    constructor (options = {}) {
        ...
        this._controller = new ZwaveController(this._options.usb, this._options)
     ...
     */
     run () {
        this._publish("$SYS/zwave/removefailednode", "nop", "zwave restarted")
        this._publish("$SYS/zwave/addnode", "nop", "zwave restarted")
    }
}
