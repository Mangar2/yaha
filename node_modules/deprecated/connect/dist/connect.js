...
class Connect {
    ...
    constructor(clientId, brokerHost, brokerPort, listenerPort) {
        ...
        this._callbacks = new utils_1.Callbacks();
 ...
 */
    ...
    async disconnect(version = '1.0') {
        const httpObjects = mqtt_utils_1.Interfaces.disconnect(version, this._clientId);
    ...
    async subscribe(topics, version = '1.0') {
        const httpObjects = mqtt_utils_1.Interfaces.subscribe(version, topics, this._clientId, this._providePacketId());
    ...
    async unsubscribe(topics, version = '1.0') {
        const httpObjects = mqtt_utils_1.Interfaces.unsubscribe(version, topics, this._clientId, this._providePacketId());
