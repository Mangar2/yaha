...
const PatternTree = require('deprecated/topicmatch/patterntree')
...
class TopicMatch {
    ...
    /**
     * @description hide the _tree from the JSON formatting
     */
    toJSON () {
        return {
     ...
     * @property {Object}
     */
    get topicPatternList () { return this._topicPatternList }
